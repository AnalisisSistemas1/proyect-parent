package com.cope.security.config;
...
@EnableJpaRepositories(
        basePackages = "com.cope.security.repository",
...
public class MysqlJpaConfiguration {
    ...
    @Autowired
    public MysqlJpaConfiguration(@Qualifier("mysqlDatasource") DataSource dataSource){
    ...
    public EntityManagerFactory buildEntityMangerFactory(){
        ...
        localContainer.setPackagesToScan("com.cope.security.model");
